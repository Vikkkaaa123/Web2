...
<body>
    ...
    <form action="index.php" method="POST">
        ...
        <input type="text" id="full_name" name="full_name" placeholder="Введите Ваше фамилию, имя, отчество" required maxlength="150" value="<?php echo htmlspecialchars($values['full_name']); ?>" <?php if ($errors['full_name']) echo 'class="error"'; ?>><br>

        <label for="phone">Телефон:</label>
        <input type="tel" id="phone" name="phone" placeholder="+7" required value="<?php echo htmlspecialchars($values['phone']); ?>" <?php if ($errors['phone']) echo 'class="error"'; ?>><br>

        <label for="email">E-mail:</label>
        <input type="email" id="email" name="email" placeholder="Введите Вашу почту" required value="<?php echo htmlspecialchars($values['email']); ?>" <?php if ($errors['email']) echo 'class="error"'; ?>><br>
        ...
        <textarea id="biography" name="biography" required <?php if ($errors['biography']) echo 'class="error"'; ?>><?php echo htmlspecialchars($values['biography']); ?></textarea><br>
